    ...
    <div class="content">
      ...
      <div class="timetobuy">
        ...
        <div class="timetobuylist">
          <ul class="list">
            <li
              v-for="(flashSale, index) in flashSaleModule.itemList"
              :key="index"
            >
        ...
        <div class="newproductlist">
          <ul class="list">
            <li>
              ...
              <p class="introduce">告别桌面沙发尘屑毛发，mini桌面吸尘器</p>
      ...
      <div class="bottomnav">
        <ul class="list">
          <li>
            <span class="list_top1">断货补单王</span>
            <span class="list_top2">补仓疯抢中</span>
            <div class="list_img">
...
<script>
 import Vue from "vue";
import { Icon, Grid, GridItem, CountDown } from "vant";
